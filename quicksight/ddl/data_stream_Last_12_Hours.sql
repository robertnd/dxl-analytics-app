/* 
This query selects 12 hours from the top of the previous hour
*/
select
...
where 
eventhour between cast(date_part('h', dateadd(hour,-13,convert_timezone('EAT', sysdate)) ) as integer) and cast(date_part('h', dateadd(hour,-1,convert_timezone('EAT', sysdate)) ) as integer) and
