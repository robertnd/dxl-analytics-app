...
where 
eventhour between cast(date_part('h', dateadd(hour,-4,convert_timezone('EAT', sysdate)) ) as integer) and cast(date_part('h', dateadd(hour,-1,convert_timezone('EAT', sysdate)) ) as integer) and
